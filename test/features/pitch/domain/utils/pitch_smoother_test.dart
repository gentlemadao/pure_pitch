...
void main() {
  group('PitchSmoother', () {
    test('should reject extreme outliers (Vocal Range Gating)', () {
      ...
      expect(result.hz, equals(440.0), reason: 'Extreme spike should be rejected');
    });
    ...
    test('smoothBatch should remove short spikes in a sequence', () {
      ...
      expect(refined[2], equals(440.0), reason: 'Spike should be replaced by median');
    });

    test('should dampen noisy input data', () {
      final smoother = PitchSmoother(emaAlpha: 0.1); // Low alpha for high smoothing
      ...
      final noisyInput = [
        440.0, 490.0, 390.0, 440.0, 460.0, 420.0, 440.0, 1000.0, 440.0 // 1000 is a spike
      ];
      ...
      expect(smoothedOutput[7], closeTo(440.0, 50.0), reason: 'Spike should be rejected by median filter');
